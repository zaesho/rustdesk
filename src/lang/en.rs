...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("wol_target_tip", "Broadcast address of the target's subnet (e.g. 192.168.1.255), or its IP for a unicast packet. Required to wake a host that is not on your local network."),
    ].iter().cloned().collect();
}
